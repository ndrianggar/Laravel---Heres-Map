if (navigator.geolocation) {
    navigator.geolocation.getCurrentPosition(position => {
        ...
        function addRouteShapeToMap(route) {
            ...
            // fungsi ini digunakan untuk perulangan garis2 pada map        
            ...
            // fungsi style dalam memberi garis
    ...
    // open url direction. (_self) = berfungsi untuk open window pada halaman yg sama

    function openDirection(lat, lng, id) {
        window.open(`/space/${id}?from=${objLocalCoord.lat},${objLocalCoord.lng}&to=${lat},${lng}`,
            "_self");
    }

} else {
    console.error("Geolocation is no supported by this browser!");
